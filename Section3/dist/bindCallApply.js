...
var car = {
    ...
    displayDetails1: function (owner, color) {
        console.log("this refers to ", this);
    ...
    returnDetails: function (owner, color) {
        console.log("this refers to ", this);
...
console.log("-------------call after using bind with parameters------------------");
console.log(myCarDetails);
console.log("return type of myCarDetails is " + typeof myCarDetails);
myCarDetails();
console.log("");
...
var bike = { registrationNumber: "DL2SP9193", brand: "Bajaj" };
console.log("-------------call after using apply------------------");
console.log("return type using apply is " + typeof car.displayDetails.apply(bike));
car.displayDetails.apply(bike);
console.log("");
console.log("-------------call after using apply with parameters no return type------------------");
//the parameters are passed as an array
console.log("return type using apply is " +
    typeof car.displayDetails1.apply(bike, ["Rudhra", "kaala re"]));
car.displayDetails1.apply(bike, ["Rudhra", "kaala re"]);
console.log("-------------call after using apply with parameters and return type------------------");
//the parameters are passed as an array
// the return type depend upon what actually is returned from the method being called
var details = car.returnDetails.apply(bike, ["Rudhra", "kaala re"]);
...
console.log("return type using call is " + typeof car.displayDetails.call(bike));
car.displayDetails.call(bike);
console.log("-------------call after using call with parameters no return type------------------");
