...
var button4 = document.querySelector("Nonexistingbutton");
...
var button5 = document.querySelector("button");
function clickHandler(message, num1) {
...
console.log("");
console.log("---------------------Code quality options----------------------------");
//--------------------------noUnusedLocals---------------
console.log("");
...
function demoNoUnusedParameters(name, age) {
...
function demoNoImplicitReturns(num1, num2) {
    if (num1 + num2 > 0) {
        return num1 + num2;
    }
    else if (num1 + num2 == 0) {
...
function demoNoFallthroughCasesInSwitch(num1) {
    switch (num1) {
        case 1:
